          ...
          <div className="mb-10">
            <div className="bg-white/10 border border-white/10 backdrop-blur-md rounded-3xl p-8 md:p-10">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                <div>
                  <div className="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-500/20 text-blue-300 px-4 py-2 rounded-full text-sm mb-5">
                    <HeartPulse size={16} />
                    Patient Dashboard
                  </div>
                  ...
                  <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
                    Welcome Back{" "}
                    <span className="text-blue-400">{me?.first_name}</span>
                  </h1>

                  <p className="text-gray-300 text-lg max-w-2xl leading-relaxed">
                    Manage your healthcare appointments, connect with doctors,
                    and stay updated with your upcoming medical schedules
                    seamlessly.
                  </p>
                </div>
                ...
                <div className="bg-black/20 border border-white/10 rounded-3xl p-6 min-w-[280px]">
                  <div className="flex items-center gap-3 mb-5">
                    <UserRound className="text-blue-400" size={24} />
          ...
          {!logged && (
            <div className="text-center py-24">
              ...
              <p className="text-gray-300 mb-8">
                Login to access your patient dashboard and appointments.
              </p>

              <Link href="/auth/login">
                <button className="bg-blue-600 hover:bg-blue-700 px-8 py-4 rounded-2xl font-semibold transition">
                  Login
                </button>
              </Link>
            </div>
          ...
          {logged && !profileComplete && (
            <div className="bg-white/10 border border-white/10 backdrop-blur-md p-10 rounded-3xl text-center max-w-3xl mx-auto">
              ...
              <p className="text-gray-300 mb-8 text-lg leading-relaxed">
                Complete your patient profile to start booking appointments and
                accessing healthcare services seamlessly.
              </p>
              ...
              <div className="mb-10">
                ...
                <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                  <DashboardCard
                    ...
                    desc="Find available doctors and book appointments quickly."
                  ...
                  <DashboardCard
                    ...
                    desc="View upcoming and previous appointment history."
                    link="/patient/appointment/my"
                    color="bg-purple-600"
                  ...
                  <DashboardCard
                    ...
                    desc="Manage and update your patient information."
                    link="/patient/update-profile"
                    color="bg-green-600"
